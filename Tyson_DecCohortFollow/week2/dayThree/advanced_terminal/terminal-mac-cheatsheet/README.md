...
| which [file]/[dir] | Tells you where the file is located

## SEARCH

| Key/Command | Description |
| ----------- | ----------- |
|find . -type d -name [directory] - finds directory ex: find . -type d -name RefactorU
|find . -type f -name [file] - finds file ex: find . -type f -name main.js
...
Tyson- good examples of terminal if you need them: 

http://www.tecmint.com/35-practical-examples-of-linux-find-command/

bash_profile- runs as soon as the computer starts.
bash_rc - only runs when the terminal is started. 
